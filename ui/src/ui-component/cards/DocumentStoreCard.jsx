                ...
                <Grid container justifyContent='space-between' direction='column' sx={{ height: '100%' }} gap={2}>
                    ...
                    <Grid container columnGap={2} rowGap={1}>
                        ...
                        >
                            ...
                            {data.linkedChatflowCount ?? 0} {(!data.linkedChatflowCount || data.linkedChatflowCount <= 1) ? 'flow' : 'flows'}
                        </div>
                        <div
                            style={{
                                paddingLeft: '7px',
                        ...
                        >
                            ...
                            {kFormatter(data.stats?.totalChars ?? 0)} chars
                        </div>
                        <div
                            style={{
                                paddingLeft: '7px',
                        ...
                        >
                            ...
                            {kFormatter(data.stats?.totalChunks ?? 0)} chunks
                        </div>
                    </Grid>
