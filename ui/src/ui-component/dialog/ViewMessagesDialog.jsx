...
import { RobotIcon } from '@/views/chatmessage/ChatMessage'
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            {message.type === 'apiMessage' ? (
                                                                <RobotIcon className='boticon' alt='AI' sx={{backgroundColor: theme.palette.primary.light, width: '25px', height: '25px', marginLeft: '10px'}}>🤖</RobotIcon>
                                                            ) : (
                                                                <img
