...
export const FileConvertToBase64Component = ({ value, formDataUpload, fileType, onChange, onFormDataChange, disabled = false }) => {
...
FileConvertToBase64Component.propTypes = {
