...
const ShareChatbot = ({ isSessionMemory, isAgentCanvas }) => {
    ...
    return (
        <>
            ...
            {textField(title, 'title', 'Title', 'string', 'Chat Assistant')}
            {textField(titleAvatarSrc, 'titleAvatarSrc', 'Title Avatar Link', 'string', `https://your-url-to-image/your-image.png`)}
            ...
            {textField(botMessageAvatarSrc, 'botMessageAvatarSrc', 'Avatar Link', 'string', `https://bot-avatar-image-url/bot-avatar.png`)}
            ...
            {textField(
                ...
                'Avatar Link',
                'string',
                `https://user-avatar-image-url/user-avatar.png`
            )}
