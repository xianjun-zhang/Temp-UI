...
import { FileInstantUploadComponent } from '@/ui-component/file/FileUploadInstant'
...
const DocStoreInputHandler = ({ inputParam, data, disabled = false, storeId, onUploadFileChange }) => {
                        ...
                        {inputParam.type === 'credential' && (
                            <CredentialInputHandler
                                ...
                                onSelect={(newValue) => {
                                    ...
                                    data.inputs[BITFLOW_CREDENTIAL_ID] = newValue // in case data.credential is not updated
                                }}
                            />
                        )}

                        {inputParam.type === 'file' && (
                            <FileInstantUploadComponent
                                disabled={disabled}
                                fileType={inputParam.fileType || '*'}
                                onChange={(newValue) => {
                                    data.inputs[inputParam.name] = newValue
                                    onUploadFileChange(newValue)
                                }}
                                existingFiles={data.inputs[inputParam.name] ?? []}
                                storeId={storeId}
                            />
                        )}
