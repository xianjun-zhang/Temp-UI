...
const Documents = () => {
    ...
    const goToDocumentStore = (id) => {
        navigate(navigationPaths.documentStore.detail(id))
    }
            ...
            try {
                ...
                for (let i = 0; i < docStores.length; i += 1) {
                    ...
                    for (let j = 0; j < loaders.length; j += 1) {
                        const imageSrc = `${baseURL}/api/v1/node-icon/${loaders[j].loaderTypeId}`
                                ...
                                <TableBody>
                                    {docStores?.filter(filterDocStores).map((data, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>{data.chatflowReferences?.length ?? 0}</TableCell>
